// static js file for file.ejs

// Search function for searching in any column according to selected column category
function searchTable() {
   var input, filter, found, table, tr, td, i, j;
   
   //getting access to the needed elements of the file.ejs page
   input = document.getElementById("search");
   filter = input.value.toUpperCase();
   table = document.getElementById("sortTable");
   tr = table.getElementsByTagName("tr");

   //getting the selected column header data
...
// Sorting code here is here
const table = document.getElementById("sortTable");
const headers = table.querySelectorAll("th");
const rows = table.querySelectorAll("tr");

//adding event listener to each header, so that when user clicks on any page then he got an icon of sorting
...
// Transform i.e. sort the content of given cell in given column
...
// Track sort directions i.e. either ascending or descending
